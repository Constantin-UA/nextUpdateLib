...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttribute = function (attrName, attrValue) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (dur = 500, display = 'block', fin) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].style) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function (dur = 500, fin) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].style) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (eventHandler, callback) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (eventHandler, callback) {
  if (!eventHandler || !callback) {
    return this;
  }
...
function mouthAAA() {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.right').toggleClass('active');
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.left').toggleClass('active');
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.right').fadeOut(800);
} //fadeIn fadeOut test


Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.hair').click(hairClick);

function hairClick() {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.right').fadeIn(800);
}
